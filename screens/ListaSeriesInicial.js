...
export default function ListaSeriesInicial() {
  ...
  return (
    <ImageBackground source={backgroundImg} style={styles.background} blurRadius={4}>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Suas Séries favoritas</Text>
        <Text style={styles.text}>
          Visualize o que já maratonou, o que está vendo e as próximas séries da lista.
        </Text>

        <TouchableOpacity
          style={styles.button}
          activeOpacity={0.8}
          onPress={() => navigation.navigate('AdicionadordeItems', { categoria: 'series' })}
        >
